...
void debug_80C3A50(u8 taskId)
{
    ...
    Menu_PrintText(gUnknown_Debug_083F7FDA, 25, 1);
    ...
    spriteId = CreateMonSpriteFromNationalDexNumber(natDexNum, 0x58, 0x28, 1);
    gSprites[spriteId].oam.affineMode = ST_OAM_AFFINE_NORMAL;
    gSprites[spriteId].oam.matrixNum = 1;
    gSprites[spriteId].oam.priority = 0;
    gSprites[spriteId].oam.paletteNum = 0;
    FreeSpritePaletteByTag(GetSpritePaletteTagByPaletteNum(gSprites[spriteId].oam.paletteNum)); // Just put 0 here, why the verbosity?
    gSprites[spriteId].y2 = gPokedexEntries[natDexNum].pokemonOffset;
...
void debug_80C6FA8(u8 taskId)
{
    ...
    {
        *(u16 *)(PLTT + 0x100 + (gUnknown_Debug_2038A20->unk7 + 1) * 2) = 0;
    ...
    else
    {
        ...
        *(u16 *)(PLTT + 0x140 + (gUnknown_Debug_2038A20->unk7 + 1) * 2) = gUnknown_Debug_083F8790[gUnknown_Debug_2038A20->random];
    }
}
