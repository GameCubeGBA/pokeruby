...
void sub_81376B8(void)
{
    ...
    if (gSprites[gHealthboxSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy)
        r4 = TRUE;
    if (r4 && gBattleSprites_healthBoxesData[gActiveBattler].unk1_0 && gBattleSprites_healthBoxesData[gActiveBattler ^ 2].unk1_0)
    {
...
void WallyHandleBallThrowAnim(void)
{
    ...
    gBattleSprites_animationData.unk8 = ballThrowCaseId;
    gDoingBattleAnim = TRUE;
    move_anim_start_t4(gActiveBattler, gActiveBattler, GetBattlerAtPosition(1), 4);
    gBattlerControllerFuncs[gActiveBattler] = CompleteOnFinishedAnimation;
}
...
void sub_81398BC(u8 bank)
{
    ...
    gSprites[gBattleControllerData[bank]].data[0] = StartSendOutMonAnimation(0, 0xFF);
}
